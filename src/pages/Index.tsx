            ...
            <div className="space-y-3">
              <button
                ...
                className={`w-full flex items-center justify-center gap-2 rounded-full border-2 py-2.5 text-sm font-medium transition-colors ${
                  showPassword
                    ? 'border-bobflix-500 bg-bobflix-50 text-bobflix-700'
                    : 'border-surface-alt text-text-secondary hover:bg-surface-alt'
                }`}
              >
                <Lock size={14} />
              ...
              <button
                ...
                disabled={!nickname.trim() || (showPassword && !password.trim())}
